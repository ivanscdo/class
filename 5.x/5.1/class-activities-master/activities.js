...
(function(){
    ...
    console.log( "charIndexes test:", charIndexes("test", ["t", "e"]));
    // console.log("test"[1]);
    // console.log(charIndexes("test", ["e", "s"]));
